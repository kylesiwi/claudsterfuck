...
<!-- /IMMUTABLE -->
- Objective: ! plugin update claudsterfuck
...
Objective keywords: plugin, update, claudsterfuck

### Relevant Files
- `plugin.json` (~82 tok)`: plugin.json` (~82 tok) (source: .wolf/anatomy.md, score: 2)
- `claudsterfuck-codex-worker.md` (~213 tok)`: claudsterfuck-codex-worker.md` (~213 tok) (source: .wolf/anatomy.md, score: 2)
